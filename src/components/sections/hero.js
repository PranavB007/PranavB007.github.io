...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Pranav Bansal</h2>;
  const three = <h3 className="medium-heading">Software Developer | Data Scientist | Data Engineer</h3>;
  const four = (
    <>
      <p>
      ...
      <p>
      Code with Precision, Deliver with Passion.
      </p>
    </>
  );
  const five = (
    <a
      ...
      href="https://www.linkedin.com/in/pranavbansal2000/"
      target="_blank"
      rel="noreferrer">
      Connect with me!
    </a>
