      ...
      <div className="inner">
        <StyledText>
          ...
          <p>
            ...
            <p>
            I worked as Research Intern at {' '}
            <a href="https://www.iitk.ac.in/">IIT K</a>, {' '} under Prof. {' '}MK Verma{' '} to build COVID 19 Cases forecasting model .
            </p>
        ...
        <StyledPic>
          <div className="wrapper">
            <StaticImage
              className="img"
              src="C:\my files\Portfolio\chandrikadeb7.github.io\src\images\me.jpeg"
              width={1100}
              height={1500}
              quality={95}
